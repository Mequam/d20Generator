...
this script prints outputs the uv coordinents of a given iso sphere
into the verticies of a new mesh!

you should only have to run it once to generate a baseline mesh,
at which point geometry nodes can take over
